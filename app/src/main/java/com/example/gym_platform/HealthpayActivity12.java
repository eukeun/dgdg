...
public class HealthpayActivity12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthpay_mon12);
        ...
        Button btnPayReserve = (Button) findViewById(R.id.botton_mon12);
    ...
    public void addDocument(String UID, Date start, Date end, String kind, String price, String gymName, String type){
        ...
        UsePoint(1500); // 150,000원이므로 1500근 삭감.
    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if( point < Integer.parseInt(document.get("userPoint").toString())) {
                            ...
                            Intent intent = new Intent(HealthpayActivity12.this, NavigationActivity.class);
