...
public class HealthpayActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthpay_mon1);
        ...
        Button btnPayReserve = (Button) findViewById(R.id.botton_mon1);
    ...
    public void addDocument(String UID, Date start, Date end, String kind, String price, String gymName, String type){
        ...
        UsePoint(343); // 34,300원이므로 343근 삭감.
    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if( point < Integer.parseInt(document.get("userPoint").toString())) {
                            ...
                            Intent intent = new Intent(HealthpayActivity1.this, NavigationActivity.class);
