...
public class HealthpayActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthpay_mon3);
        ...
        Button btnPayReserve = (Button) findViewById(R.id.botton_mon3);
    ...
    public void addDocument(String UID, Date start, Date end, String kind, String price, String gymName, String type){
        ...
        UsePoint(673); // 67,300원이므로 673근 삭감.
    }
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if( point < Integer.parseInt(document.get("userPoint").toString())) {
                            ...
                            Intent intent = new Intent(HealthpayActivity3.this, NavigationActivity.class);
